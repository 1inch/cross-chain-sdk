...
describe(__filename, () => {
    describe('base', () => {
        ...
        it('should be possible to subscribe to open connection', () =>
            new Promise<void>((resolve) => {
                const message = {id: 1}
                const {wss, url} = createWebsocketServerMock([message])
        ...
        it('this is pointed to underlying websocket', () =>
            new Promise<void>((resolve) => {
                const message = {id: 1}
                const {wss, url} = createWebsocketServerMock([message])
        ...
        it.skip('should be possible to subscribe to error', () =>
            new Promise<void>((resolve) => {
                const wsSdk = new WebSocketApi({
        ...
        it('should be possible to initialize in lazy mode', () =>
            new Promise<void>((resolve) => {
                const message = {id: 1}
                const port = getPort()
        ...
        it('should be possible to initialize not in lazy mode', () =>
            new Promise<void>((resolve) => {
                const message = {id: 1}
                const port = getPort()
        ...
        it('should be possible to pass provider instead of config', () =>
            new Promise<void>((resolve) => {
                const message = {id: 1}
        ...
        it('should be possible to initialize with new method', () =>
            new Promise<void>((resolve) => {
                const message = {id: 1}
                const port = getPort()
        ...
        it('connection can be closed and you can listen to close event', () =>
            new Promise<void>((resolve) => {
                const message = {id: 1}
                const {wss, url} = createWebsocketServerMock([message])
    ...
    describe('rpc', () => {
        ...
        it('can retrieve allowed rpc methods ', () =>
            new Promise<void>((resolve) => {
        ...
        it('getActiveOrders throws error', () =>
            new Promise<void>((resolve) => {
                const response: GetActiveOrdersRpcEvent = {
                    method: RpcMethod.GetActiveOrders,
                    result: {
    ...
    describe('order', () => {
        it('can subscribe to order events', () =>
            new Promise<void>((resolve) => {
        ...
        it('can subscribe to order created events', () =>
            new Promise<void>((resolve) => {
                const message1: OrderCreatedEvent = {
                    event: EventType.OrderCreated,
                    result: {
        ...
        it('can subscribe to order invalid events', () =>
            new Promise<void>((resolve) => {
                const message1: OrderCreatedEvent = {
                    event: EventType.OrderCreated,
                    result: {
        ...
        it('can subscribe to order_balance_change events', () =>
            new Promise<void>((resolve) => {
                const message1: OrderCreatedEvent = {
                    event: EventType.OrderCreated,
                    result: {
        ...
        it('can subscribe to order_allowance_change events', () =>
            new Promise<void>((resolve) => {
                const message1: OrderCreatedEvent = {
                    event: EventType.OrderCreated,
                    result: {
        ...
        it('can subscribe to order cancelled events', () =>
            new Promise<void>((resolve) => {
                const message1: OrderCreatedEvent = {
                    event: EventType.OrderCreated,
                    result: {
        ...
        it('can subscribe to order secret shared events', () =>
            new Promise<void>((resolve) => {
                const message1: OrderCreatedEvent = {
                    event: EventType.OrderCreated,
                    result: {
