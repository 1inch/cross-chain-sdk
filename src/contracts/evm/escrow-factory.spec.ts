...
describe('EscrowAddressFacade', () => {
    ...
    it('Should correct calc src/dst address for Ethereum 2', () => {
        ...
        expect(srcAddress).toEqual(
            Address.fromString('0xf97a2ae8f0481c1cc11bf8cb962b088bc5f6a945')
        )

        expect(dstAddress).toEqual(
            Address.fromString('0x5177d276a4b46b0cbb5ae98d296663fcee0138c4')
        )
    })
    ...
    describe('zkSync', () => {
        it('Should calc correct src address from immutables', () => {
            ...
            const factory = new EscrowFactoryZksync(
                Address.fromString('0x584aEaB186D81dbB52a8a14820c573480c3d4773')
            )
            ...
            expect(
                ...
                Address.fromString('0x98f0a945348c031f85164562bff61eb08a0629df')
            )
        })
        it('Should calc correct dst address from immutables', () => {
            ...
            expect(
                ...
                Address.fromString('0x93d8a039c23cffd1067e02edbdd28189ac679a39')
            )
        })
    })
})
