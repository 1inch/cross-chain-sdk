...
- [v2.0 Migration Guide](#changelog)
...
This release introduces **fee collection support** with integrator and resolver fees, new event decoding utilities, and API versioning.
...
### Migration Guide for v1.1 Services
